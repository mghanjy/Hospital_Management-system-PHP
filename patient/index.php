                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>لاتملك اي فكرة عن الاطباء؟ لاتوجد مشكلة إضغط على 
                                <a href="doctors.php" class="non-style-link"><b> الاطباء </b></a> جلسة أو 
                                <a href="schedule.php" class="non-style-link"><b>الجلسات</b> </a><br>
                               تتبع تأريخ المواعيد السابقة والمستقبلية<br>نعرف ايضا على وقت الوصول المتوقع لطبيبك أو مستشارك الطبي<br><br>
                            </p>
                            
                            <h3>البحث عن طبيب هنا </h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="ابحث عن طبيب وسنعرض الجلسة المتاحة" list="doctors" style="width:45%;">&nbsp;&nbsp;
                        ...
                        <table border="0" width="100%"">
                            <tr>
                                <td width="50%">
                                    ...
                                    <center>
                                        <table class="filter-container" style="border: none;" border="0">
                                            <tr>
                                                <td colspan="4">
                                                    <p style="font-size: 20px;font-weight:600;padding-left: 12px;">الحالات</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 25%;">
                                ...
                                <td>
                                    ...
                                    <p style="font-size: 20px;font-weight:600;padding-left: 40px;" class="anime">حجزك القادم</p>
                                    <center>
