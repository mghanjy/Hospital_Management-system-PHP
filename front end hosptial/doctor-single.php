    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">تفاصيل الدكتور</span>
		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-6">
				<div class="doctor-details mt-4 mt-lg-0">
					<h2 class="text-md">مقدمة عن الدكتور </h2>
					<div class="divider my-4"></div>
					<p>الدكتور </p>

					<a href="appoinment.html" class="btn btn-main-2 btn-round-full mt-3">احجز موعد الان<i
