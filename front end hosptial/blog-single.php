    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">تفاصيل</span>
          <h1 class="text-capitalize mb-5 text-lg">مدونة</h1>
...
<section class="section blog-wrap">
  <div class="container">
					...
					<div class="comment-area-box d-block d-sm-flex">
						...
						<div class="block">
							<div class="comment-info">
								...
								<span>United Kingdom</span>
								<span class="date-comm">| Posted June 7, 2022</span>
							</div>
    ...
    //              }else{
    //         //TODO
    //         $database ="insert into  comment(name,email,message values('$name','$email','$message');");
	// 			 }
	// 			}
	// 		}else{
	...
	if($_POST){
		...
		// 	 $result = $stmt->get_result();
			if (isset($_POST["send"])) {
				...
				//TODO
				$database->query("insert into comment(email,name,message) values('$email','$name','$message');");
...
?>
	<div class="col-lg-12">
		<!-- <form class="comment-form my-5" id="comment-form"  method="POST" action="">
			<h4 class="mb-4">اكتب تعليقك</h4>
			<div class="row">
				<div class="col-md-6">
			...
			<input class="form-control mb-4" name="message" id="comment" cols="30" rows="5" placeholder="Comment">
				 -->

				 <form action="" method="POST" >
                
            
				<span class="span"> <?php echo "$sms"; ?></span> <br>
			  ...
			  <tr>
				  <td class="col-md-6" colspan="2">
					  <label for="message" class="form-group"> Comment: </label>
				  </td>
			  </tr>	 
			  <tr>
                <td class="col-md-6" colspan="2">
                    <input type="txt" name="message" class="form-control mb-4"  placeholder="Comment"  >
                </td>
            </tr>
			<td>
			<input  type="submit" name="send" value="Submit Message"class="btn btn-main-2 btn-round-full">
</td>	
		</form>
	</div>
</div>
	...
	<div class="sidebar-widget latest-post mb-3">
        ...
        <div class="py-2">
        	<span class="text-sm text-muted">03 Mar 2019</span>
